...
def ft_load(path: str):  # str cadena de texto con la ruta al archivo
    ...
    - Cargar una imagen desde la ruta dada.
    - Imprimir su formato y contenido en píxeles (en formato RGB).
    - Manejar errores adecuadamente, como archivos no encontrados
    o formatos incorrectos.
    - Soportar al menos imágenes JPG y JPEG.
